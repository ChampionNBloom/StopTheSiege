	...
	override public function init()
	{
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				{
					_StartTitle = false;
					createRecycledActor(getActorType(46), 125, 50, Script.FRONT);
					loopSound(getSound(51));
				}
				if((_time == 270))
				{
					_StartButtons = true;
				...
				{
					_StartButtons = false;
					createRecycledActor(getActorType(25), 50, 300, Script.FRONT);
					createRecycledActor(getActorType(27), 400, 300, Script.FRONT);
				}
			}
		});
